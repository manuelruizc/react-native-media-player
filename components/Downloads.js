...
class Playlists extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      downloadBackground:
        "https://images.unsplash.com/photo-1567219546501-6c13203953ea?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80",
    };
  }
      ...
      >
        ...
        >
          <View>
            ...
            <Text style={{ color: "#444", fontSize: 20, marginBottom: 10 }}>
              Your playlists
            </Text>
          </View>
          <TouchableOpacity
              ...
              >
                <ImageBackground
                  ...
                  source={{
                    uri:
                      play == "songsDownloadedOnDevice"
                        ? this.state.downloadBackground
                        : play === "favorites__Playlist"
                        ? this.state.images[index % this.state.images.length]
                        : this.getPlaylistBackground(play)
                        ? this.getPlaylistBackground(play)
                        : this.state.images[index % this.state.images.length],
                  }}
                >
                  <View
                    style={{
                      width: "100%",
                      height: "100%",
                      backgroundColor: "rgba(234,76,137, 0.45)",
                      position: "absolute",
                    }}
                  >
                    <Text
    ...
    if (songData != null) {
      ...
      if (source) {
        if (songData.isDownloaded) {
          ...
          self.props.screenProps.playNewSong(
            false,
            this.props.screenProps.currentVideoIndex
          );

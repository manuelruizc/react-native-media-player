...
import { View, StyleSheet, Dimensions, ScrollView, Animated, Image } from 'react-native';
...
const FullPlayer = ({
    ...
    return (
        <View style={[styles.container, fullscreen ? fullscreenActive : fullscreenUnactive]}>
            {children}
        </View>
    );
}
...
const SongInfoContainer = ({children}) => <View style={styles.songInfoContainer}>{children}</View>
const InfoBar = ({children}) => <View style={styles.infoBar}>{children}</View>
const InfoBarOptions = ({children}) => <View style={styles.infoBarOptions}>{children}</View>
